...
1. One round only
3. All Community Cards dealt at once
4. One betting round only
5. No chips involved
6. All betting choices bar folding are functionally identical
...
--> Accommodate for scalability

**Good code > Complex logic**
...
--> How: Go through game flow and add it to the "Brief" section of this file
